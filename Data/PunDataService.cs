    ...
    public class PunDataService
    {
        ...
        public PunDataService()
        {
            if (File.Exists("./puns.dat"))
            {
                ...
                using (var stream = new FileStream("./puns.dat", FileMode.Open, FileAccess.Read, FileShare.None))
                {
        ...
        {
            var formatter = new BinaryFormatter();
            using (var stream = new FileStream("./puns.dat", FileMode.Create, FileAccess.Write, FileShare.None))
            {
